...
ENTRIES = [
    ("ba", "balon", "🎈"), ("be", "beczka", "🛢️"), ("bo", "bocian", CUSTOM_SVG),
    ...
    ("da", "dach", "🏠"), ("de", "deska", CUSTOM_SVG), ("do", "dom", "🏡"),
    ("du", "duch", "👻"), ("dy", "dynia", "🎃"),
    ...
    ("ju", "judo", "🥋"),
    ("ka", "kaczka", "🦆"), ("ke", "kelner", CUSTOM_SVG), ("ko", "kot", "🐈"),
    ("ku", "kura", "🐔"), ("ki", "kino", "🎬"),
    ...
    ("ru", "rura", CUSTOM_SVG), ("ry", "ryba", "🐟"),
    ("sa", "samolot", "✈️"), ("se", "ser", "🧀"), ("so", "sowa", "🦉"),
    ("su", "suwak", CUSTOM_SVG), ("sy", "syrena", "🧜‍♀️"),
    ...
    ("dzia", "dziadek", "👴"), ("dzie", "dziecko", "🧒"), ("dzio", "dziobak", CUSTOM_SVG),
    ("dziu", "dziura", "🕳️"), ("dzi", "dzik", "🐗"),
    ("dża", "Dżakarta", "🏙️"), ("dże", "dżem", "🍓"), ("dżo", "dżokej", "🏇"),
    ("dżu", "dżungla", "🌴"), ("dży", "dżdżysty", "🌧️"),
    ("rza", "Marzanna", "🎎"), ("rze", "rzeka", "🏞️"), ("rzo", "rzodkiewka", CUSTOM_SVG),
    ("rzu", "rzutka", "🎯"), ("rzy", "grzyb", "🍄"),
    ("sza", "szafa", "🚪"), ("sze", "szelki", "🦺"), ("szo", "szop", "🦝"),
    ("szu", "szuflada", "🗄️"), ("szy", "szyszka", CUSTOM_SVG),
]
